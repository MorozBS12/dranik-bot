...
const BUTTON_COMMAND_MAP = {
  ...
  'btn_qualtest_dcart':   'qualtest-dcart',
...
client.on('interactionCreate', async interaction => {
  ...
  if (interaction.isModalSubmit()) {
    ...
    else if (customId.startsWith('qualtest_dcart'))   commandName = 'qualtest-dcart';
    ...
    else if (customId.startsWith('result-dcart'))     commandName = 'result-dcart';
